...
In contrast, the method we propose uses a \emph{parametric} density estimation model which is a different mechanism to sidestep this challenge.\don{Well, a parametric method would need to finetune the parameters; I thought a non-parametric method is usually preferred.}
...
Each of them induces 2-dimensional manifold in the data space, but variance coming from the latter factor is much larger.\don{Well, maybe we should try to split the object into multiple sub-manifolds or subspaces.} 
